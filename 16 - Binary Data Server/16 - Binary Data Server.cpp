// 16 - Binary Data Server.cpp : Define el punto de entrada de la aplicación.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY16BINARYDATASERVER, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY16BINARYDATASERVER));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY16BINARYDATASERVER));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MY16BINARYDATASERVER);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_TIMER:
    {
        ...
        case IDT_TIMER1:
            XTrace(L"WM_TIMER\n");
            if (WSAnb.status == OBDC_Server::STATE::LISTENING) WSAnb.testForEvents();
...
void UpdateUI(HWND hwnd, HDC hdc, const wchar_t* message) {
    ...
    for (unsigned int index = 1; index < lastClientControl; index++) {
        ...
        OBDC_Server::socketaddress_to_string(&WSAnb.AddressArray[index], ip_wchar, port_wchar);
